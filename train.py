...
def init_train_args():
    ...
    parser.add_argument("--sample", type=str, default="ddim", choices=sample_choices)
    # Set network
    ...
    parser.add_argument("--run_name", "-n", type=str, default="X-Ray_gen")
    # Total epoch for training (required)
    parser.add_argument("--epochs", "-e", type=int, default=300)
    # Batch size for training (required)
    parser.add_argument("--batch_size", "-b", type=int, default=1) # 实现梯度累计
    ...
    parser.add_argument("--image_size", "-i", type=parse_image_size_type, default=128)
    ...
    parser.add_argument("--dataset_path", type=str, default="./datasets/X-Ray")
    ...
    parser.add_argument("--lr_func", type=str, default="warmup_cosine", choices=lr_func_choices)
    ...
    parser.add_argument("--save_model_interval_epochs", type=int, default=50)
    ...
    parser.add_argument("--start_model_interval", type=int, default=49)
    ...
    parser.add_argument("--cfg_scale", type=int, default=4)
