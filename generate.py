...
def init_generate_args():
    ...
    parser.add_argument("--generate_name", "-n", type=str, default="X-Ray_gen")
    ...
    parser.add_argument("--image_size", "-i", type=parse_image_size_type, default=256)
    ...
    parser.add_argument("--weight_path", type=str, default="./results/X-Ray_gen/ckpt_last.pt")
    # Saving path (required)
    parser.add_argument("--result_path", type=str, default="./results/X-Ray_gen/images_256/Emphysema")
...
if __name__ == "__main__":
    ...
    for i in range(125): # 减小num_images，增大循环次数
